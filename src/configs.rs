...
pub const ANT_INITIAL_PH_STRENGTH: f32 = 100.0; // 32 -> 100 상향 (더 진한 자국)
pub const ANT_PH_STRENGTH_DECAY_RATE: f32 = 0.7;
pub const ANT_PH_STRENGTH_DECAY_INTERVAL: f32 = 0.5;
pub const ANT_PH_DROP_INTERVAL: f32 = 0.5; // 더 자주 뿌림 (0.7 -> 0.5)
...
pub const PH_DECAY_RATE: f32 = 1.0; // 0.15 -> 1.0 상향
...
// Food
pub const FOOD_SPAWN_INTERVAL: f32 = 600.0; // 10분에 한 번 생성
pub const FOOD_PICKUP_RADIUS: f32 = 30.0;
pub const FOOD_SPRITE_SCALE: f32 = 1.5;
pub const FOOD_UNITS_PER_ENTITY: u32 = 10000; // 100 -> 10,000 (100배 더 오래 유지)
